...
wire          coreuser_value;
wire          coreuser_get_asid_value_status;
wire          coreuser_get_asid_value_we;
reg           coreuser_get_asid_value_re = 1'd0;
wire    [1:0] coreuser_mpp;
reg     [1:0] coreuser_set_privilege_storage = 2'd0;
reg           coreuser_set_privilege_re = 1'd0;
wire          coreuser_enable0;
wire          coreuser_asid2;
wire          coreuser_ppn_a;
wire          coreuser_ppn_b;
wire          coreuser_privilege0;
reg     [4:0] coreuser_control_storage = 5'd0;
...
reg           coreuser_require_priv = 1'd0;
reg     [1:0] coreuser_privilege1 = 2'd0;
wire    [8:0] coreuser_asid_rd_adr;
wire          coreuser_asid_rd_dat;
wire   [15:0] coreuser_asid_rd_dat_mux;
wire    [8:0] coreuser_asid_wr_adr;
wire          coreuser_asid_wr_dat;
reg    [15:0] coreuser_asid_wr_dat_demux = 16'd0;
reg    [15:0] coreuser_asid_wr_mask_demux = 16'd0;
wire          coreuser_asid_wr_we;
reg     [3:0] coreuser_coreuser_mux_delay = 4'd0;
wire   [15:0] coreuser_readback_rd_dat_mux;
reg     [3:0] coreuser_readback_shift_delay = 4'd0;
...
reg    [19:0] ticktimer_prescaler = 20'd800000;
...
wire          mailbox_tx_err;
wire          mailbox_rx_err;
reg    [25:0] mailbox_status_status1 = 26'd0;
...
reg     [9:0] mailbox_syncfifobufferedmacro0_fifo_consume = 10'd0;
reg     [9:0] mailbox_syncfifobufferedmacro0_fifo_wrport_adr = 10'd0;
...
reg     [9:0] mailbox_syncfifobufferedmacro1_fifo_consume = 10'd0;
reg     [9:0] mailbox_syncfifobufferedmacro1_fifo_wrport_adr = 10'd0;
...
reg           mb_client_w_abort = 1'd0;
wire          mb_client_r_abort;
wire          mb_client_reset_n;
reg    [31:0] mb_client_wdata_storage = 32'd0;
reg           mb_client_wdata_re = 1'd0;
wire   [31:0] mb_client_rdata_status;
wire          mb_client_rdata_we;
reg           mb_client_rdata_re = 1'd0;
wire          mb_client_irq;
wire          mb_client_available_status;
reg           mb_client_available_pending = 1'd0;
wire          mb_client_available_trigger;
reg           mb_client_available_clear = 1'd0;
wire          mb_client_abort_init_status;
reg           mb_client_abort_init_pending = 1'd0;
reg           mb_client_abort_init_trigger = 1'd0;
reg           mb_client_abort_init_clear = 1'd0;
reg           mb_client_abort_init_trigger_d = 1'd0;
wire          mb_client_abort_done_status;
reg           mb_client_abort_done_pending = 1'd0;
reg           mb_client_abort_done_trigger = 1'd0;
reg           mb_client_abort_done_clear = 1'd0;
reg           mb_client_abort_done_trigger_d = 1'd0;
wire          mb_client_error_status;
reg           mb_client_error_pending = 1'd0;
wire          mb_client_error_trigger;
reg           mb_client_error_clear = 1'd0;
reg           mb_client_error_trigger_d = 1'd0;
wire          mb_client_available0;
wire          mb_client_abort_init0;
wire          mb_client_abort_done0;
wire          mb_client_error0;
reg     [3:0] mb_client_status_status0 = 4'd0;
wire          mb_client_status_we0;
reg           mb_client_status_re0 = 1'd0;
wire          mb_client_available1;
wire          mb_client_abort_init1;
wire          mb_client_abort_done1;
wire          mb_client_error1;
reg     [3:0] mb_client_pending_status = 4'd0;
wire          mb_client_pending_we;
reg           mb_client_pending_re = 1'd0;
reg     [3:0] mb_client_pending_r = 4'd0;
wire          mb_client_available2;
wire          mb_client_abort_init2;
wire          mb_client_abort_done2;
wire          mb_client_error2;
reg     [3:0] mb_client_enable_storage = 4'd0;
reg           mb_client_enable_re = 1'd0;
wire          mb_client_rx_avail;
reg           mb_client_tx_free = 1'd0;
wire          mb_client_abort_in_progress0;
wire          mb_client_abort_ack0;
reg           mb_client_tx_err = 1'd0;
reg           mb_client_rx_err = 1'd0;
reg     [5:0] mb_client_status_status1 = 6'd0;
wire          mb_client_status_we1;
reg           mb_client_status_re1 = 1'd0;
reg           mb_client_abort = 1'd0;
reg           mb_client_control_storage = 1'd0;
reg           mb_client_control_re = 1'd0;
reg           mb_client_done = 1'd0;
reg           mb_client_done_storage = 1'd0;
reg           mb_client_done_re = 1'd0;
reg           mb_client_abort_in_progress1 = 1'd0;
reg           mb_client_abort_ack1 = 1'd0;
wire   [31:0] w_dat;
wire          w_valid;
wire          w_ready;
wire          w_done;
...
reg           csrbank0_get_asid_value_re = 1'd0;
wire          csrbank0_get_asid_value_r;
reg           csrbank0_get_asid_value_we = 1'd0;
wire          csrbank0_get_asid_value_w;
reg           csrbank0_set_privilege0_re = 1'd0;
wire    [1:0] csrbank0_set_privilege0_r;
reg           csrbank0_set_privilege0_we = 1'd0;
wire    [1:0] csrbank0_set_privilege0_w;
reg           csrbank0_control0_re = 1'd0;
wire    [4:0] csrbank0_control0_r;
reg           csrbank0_control0_we = 1'd0;
wire    [4:0] csrbank0_control0_w;
...
reg           csrbank24_wdata0_re = 1'd0;
wire   [31:0] csrbank24_wdata0_r;
reg           csrbank24_wdata0_we = 1'd0;
wire   [31:0] csrbank24_wdata0_w;
reg           csrbank24_rdata_re = 1'd0;
wire   [31:0] csrbank24_rdata_r;
reg           csrbank24_rdata_we = 1'd0;
...
reg           csrbank24_status_re = 1'd0;
wire    [5:0] csrbank24_status_r;
reg           csrbank24_status_we = 1'd0;
...
reg           csrbank24_done0_re = 1'd0;
wire          csrbank24_done0_r;
reg           csrbank24_done0_we = 1'd0;
...
reg           csrbank25_pc_re = 1'd0;
wire   [31:0] csrbank25_pc_r;
reg           csrbank25_pc_we = 1'd0;
...
reg           csrbank26_resume_time1_re = 1'd0;
wire   [31:0] csrbank26_resume_time1_r;
reg           csrbank26_resume_time1_we = 1'd0;
wire   [31:0] csrbank26_resume_time1_w;
reg           csrbank26_resume_time0_re = 1'd0;
wire   [31:0] csrbank26_resume_time0_r;
reg           csrbank26_resume_time0_we = 1'd0;
...
reg           csrbank26_status_re = 1'd0;
wire          csrbank26_status_r;
reg           csrbank26_status_we = 1'd0;
wire          csrbank26_status_w;
reg           csrbank26_state0_re = 1'd0;
wire    [1:0] csrbank26_state0_r;
reg           csrbank26_state0_we = 1'd0;
wire    [1:0] csrbank26_state0_w;
reg           csrbank26_interrupt0_re = 1'd0;
wire          csrbank26_interrupt0_r;
reg           csrbank26_interrupt0_we = 1'd0;
...
reg    [31:0] interface27_bank_bus_dat_r = 32'd0;
wire          interface27_bank_bus_re;
reg           csrbank27_control0_re = 1'd0;
wire          csrbank27_control0_r;
reg           csrbank27_control0_we = 1'd0;
wire          csrbank27_control0_w;
reg           csrbank27_time1_re = 1'd0;
wire   [31:0] csrbank27_time1_r;
reg           csrbank27_time1_we = 1'd0;
wire   [31:0] csrbank27_time1_w;
reg           csrbank27_time0_re = 1'd0;
wire   [31:0] csrbank27_time0_r;
reg           csrbank27_time0_we = 1'd0;
wire   [31:0] csrbank27_time0_w;
reg           csrbank27_msleep_target1_re = 1'd0;
wire   [31:0] csrbank27_msleep_target1_r;
reg           csrbank27_msleep_target1_we = 1'd0;
wire   [31:0] csrbank27_msleep_target1_w;
reg           csrbank27_msleep_target0_re = 1'd0;
wire   [31:0] csrbank27_msleep_target0_r;
reg           csrbank27_msleep_target0_we = 1'd0;
wire   [31:0] csrbank27_msleep_target0_w;
reg           csrbank27_ev_status_re = 1'd0;
wire          csrbank27_ev_status_r;
reg           csrbank27_ev_status_we = 1'd0;
wire          csrbank27_ev_status_w;
reg           csrbank27_ev_pending_re = 1'd0;
wire          csrbank27_ev_pending_r;
reg           csrbank27_ev_pending_we = 1'd0;
wire          csrbank27_ev_pending_w;
reg           csrbank27_ev_enable0_re = 1'd0;
wire          csrbank27_ev_enable0_r;
reg           csrbank27_ev_enable0_we = 1'd0;
...
reg     [1:0] cramsoc_mailboxclient_state = 2'd0;
reg     [1:0] cramsoc_mailboxclient_next_state = 2'd0;
reg           mb_client_abort_ack1_mailboxclient_next_value0 = 1'd0;
reg           mb_client_abort_ack1_mailboxclient_next_value_ce0 = 1'd0;
reg           mb_client_abort_in_progress1_mailboxclient_next_value1 = 1'd0;
reg           mb_client_abort_in_progress1_mailboxclient_next_value_ce1 = 1'd0;
...
always @(*) begin
    ...
    case (coreuser_asid_wr_adr[3:0])
        1'd0: begin
            coreuser_asid_wr_mask_demux <= 1'd1;
        end
        1'd1: begin
            coreuser_asid_wr_mask_demux <= 2'd2;
        end
        2'd2: begin
            coreuser_asid_wr_mask_demux <= 3'd4;
        end
        2'd3: begin
            coreuser_asid_wr_mask_demux <= 4'd8;
        end
        3'd4: begin
            coreuser_asid_wr_mask_demux <= 5'd16;
        end
        3'd5: begin
            coreuser_asid_wr_mask_demux <= 6'd32;
        end
        3'd6: begin
            coreuser_asid_wr_mask_demux <= 7'd64;
        end
        3'd7: begin
            coreuser_asid_wr_mask_demux <= 8'd128;
        end
        4'd8: begin
            coreuser_asid_wr_mask_demux <= 9'd256;
        end
        4'd9: begin
            coreuser_asid_wr_mask_demux <= 10'd512;
        end
        4'd10: begin
            coreuser_asid_wr_mask_demux <= 11'd1024;
        end
        4'd11: begin
            coreuser_asid_wr_mask_demux <= 12'd2048;
        end
        4'd12: begin
            coreuser_asid_wr_mask_demux <= 13'd4096;
        end
        4'd13: begin
            coreuser_asid_wr_mask_demux <= 14'd8192;
        end
        4'd14: begin
            coreuser_asid_wr_mask_demux <= 15'd16384;
        end
        4'd15: begin
            coreuser_asid_wr_mask_demux <= 16'd32768;
        end
    endcase
end
always @(*) begin
    coreuser_asid_wr_dat_demux <= 16'd0;
    case (coreuser_asid_wr_adr[3:0])
        1'd0: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 1'd0);
        end
        1'd1: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 1'd1);
        end
        2'd2: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 2'd2);
        end
        2'd3: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 2'd3);
        end
        3'd4: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 3'd4);
        end
        3'd5: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 3'd5);
        end
        3'd6: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 3'd6);
        end
        3'd7: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 3'd7);
        end
        4'd8: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd8);
        end
        4'd9: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd9);
        end
        4'd10: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd10);
        end
        4'd11: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd11);
        end
        4'd12: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd12);
        end
        4'd13: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd13);
        end
        4'd14: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd14);
        end
        4'd15: begin
            coreuser_asid_wr_dat_demux <= (coreuser_asid_wr_dat <<< 4'd15);
        end
    endcase
end
assign coreuser_value = (coreuser_readback_rd_dat_mux >>> coreuser_readback_shift_delay);
assign coreuser_asid_rd_adr = cramsoc_satp_asid;
assign coreuser_coreuser_asid = coreuser_asid_rd_dat;
...
assign mb_client_w_valid = mb_client_wdata_re;
assign mb_client_w_done = mb_client_done;
always @(*) begin
    mb_client_tx_free <= 1'd0;
    if ((mb_client_w_valid & (~mb_client_w_ready))) begin
        mb_client_tx_free <= 1'd0;
    end else begin
        mb_client_tx_free <= 1'd1;
    end
end
...
assign coreuser_get_asid_value_status = coreuser_value;
assign csrbank0_get_asid_value_w = coreuser_get_asid_value_status;
assign coreuser_get_asid_value_we = csrbank0_get_asid_value_we;
assign coreuser_mpp = coreuser_set_privilege_storage[1:0];
assign csrbank0_set_privilege0_w = coreuser_set_privilege_storage[1:0];
...
assign coreuser_privilege0 = coreuser_control_storage[4];
assign csrbank0_control0_w = coreuser_control_storage[4:0];
...
always @(posedge sys_clk) begin
    ...
    if (csrbank0_sel) begin
        case (interface0_bank_bus_adr[9:0])
            ...
            2'd2: begin
                interface0_bank_bus_dat_r <= csrbank0_get_asid_value_w;
            end
            2'd3: begin
                interface0_bank_bus_dat_r <= csrbank0_set_privilege0_w;
            end
            3'd4: begin
    ...
    coreuser_get_asid_value_re <= csrbank0_get_asid_value_re;
    if (csrbank0_set_privilege0_re) begin
        coreuser_set_privilege_storage[1:0] <= csrbank0_set_privilege0_r;
    end
    coreuser_set_privilege_re <= csrbank0_set_privilege0_re;
    if (csrbank0_control0_re) begin
        coreuser_control_storage[4:0] <= csrbank0_control0_r;
    end
    ...
    if (sys_rst) begin
        ...
        coreuser_set_privilege_storage <= 2'd0;
        coreuser_set_privilege_re <= 1'd0;
        coreuser_control_storage <= 5'd0;
        ...
        coreuser_require_priv <= 1'd0;
        coreuser_privilege1 <= 2'd0;
        coreuser_coreuser_mux_delay <= 4'd0;
        coreuser_readback_shift_delay <= 4'd0;
...
Ram_1w_1rs #(
	...
	.rd_addr(coreuser_asid_rd_adr[8:4]),
	.rd_clk(sys_clk),
	.rd_en(1'd1),
	.wr_addr(coreuser_asid_wr_adr[8:4]),
	.wr_clk(sys_clk),
	.wr_data(coreuser_asid_wr_dat_demux),
	.wr_en(coreuser_asid_wr_we),
	.wr_mask(coreuser_asid_wr_mask_demux),
	.rd_data(coreuser_asid_rd_dat_mux)
);

Ram_1w_1rs #(
	.clockCrossing(1'd0),
	.ramname("RAM_DP_32_16_MM"),
	.rdAddressWidth(3'd5),
	.rdDataWidth(5'd16),
	.wordCount(6'd32),
	.wordWidth(5'd16),
	...
	.wr_en(coreuser_asid_wr_we),
	.wr_mask(coreuser_asid_wr_mask_demux),
	.rd_data(coreuser_readback_rd_dat_mux)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-05-15 17:15:31.
//------------------------------------------------------------------------------
