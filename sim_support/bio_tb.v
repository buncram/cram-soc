...
always @(*) begin
    ...
    gpio_i <= 32'd0;
    if (force_1) begin
        gpio_i[0] <= force_val[0];
    end else begin
        gpio_i[0] <= gpio_o[0];
    end
    if (force_1) begin
        gpio_i[1] <= force_val[1];
    end else begin
        gpio_i[1] <= gpio_o[1];
    end
    if (i2c) begin
    ...
    if (force_1) begin
        gpio_i[4] <= force_val[4];
    end else begin
        gpio_i[4] <= gpio_o[4];
    end
    if (force_1) begin
        gpio_i[5] <= force_val[5];
    end else begin
        gpio_i[5] <= gpio_o[5];
    end
    if (force_1) begin
        gpio_i[6] <= force_val[6];
    end else begin
        gpio_i[6] <= gpio_o[6];
    end
    if (force_1) begin
        gpio_i[7] <= force_val[7];
    end else begin
        gpio_i[7] <= gpio_o[7];
    end
    if (force_1) begin
        gpio_i[8] <= force_val[8];
    end else begin
        gpio_i[8] <= gpio_o[8];
    end
    if (force_1) begin
        gpio_i[9] <= force_val[9];
    end else begin
        gpio_i[9] <= gpio_o[9];
    end
    if (force_1) begin
        gpio_i[10] <= force_val[10];
    end else begin
        gpio_i[10] <= gpio_o[10];
    end
    if (force_1) begin
        gpio_i[11] <= force_val[11];
    end else begin
        gpio_i[11] <= gpio_o[11];
    end
    if (force_1) begin
        gpio_i[12] <= force_val[12];
    end else begin
        gpio_i[12] <= gpio_o[12];
    end
    if (force_1) begin
        gpio_i[13] <= force_val[13];
    end else begin
        gpio_i[13] <= gpio_o[13];
    end
    if (force_1) begin
        gpio_i[14] <= force_val[14];
    end else begin
        gpio_i[14] <= gpio_o[14];
    end
    if (force_1) begin
        gpio_i[15] <= force_val[15];
    end else begin
        gpio_i[15] <= gpio_o[15];
    end
    if (force_1) begin
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2024-11-22 13:01:44.
//------------------------------------------------------------------------------
