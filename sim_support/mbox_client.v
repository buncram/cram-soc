...
assign mbox_w_valid = (cr_wdata_written_aclk & (~w_valid_r));
assign mbox_w_done = (ar_done_aclk & (~ar_done_r));
always @(*) begin
    sfr_sr_tx_free <= 1'd0;
    if ((mbox_w_valid & (~mbox_w_ready))) begin
        sfr_sr_tx_free <= 1'd0;
    end else begin
        sfr_sr_tx_free <= 1'd1;
    end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-08-01 23:52:02.
//------------------------------------------------------------------------------
