...
module  axi2ahb_ctrl (clk,reset,HADDR,HBURST,HSIZE,HTRANS,HWRITE,HWDATA,HRDATA,HREADY,HRESP,ahb_finish,rdata_phase,wdata_phase,data_last,rdata_ready,wdata_ready,cmd_empty,cmd_read,cmd_addr,cmd_len,cmd_size);
