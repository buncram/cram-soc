...
module  axi2ahb (clk,reset,AWID,AWADDR,AWLEN,AWSIZE,AWVALID,AWREADY,WID,WDATA,WSTRB,WLAST,WVALID,WREADY,BID,BRESP,BVALID,BREADY,ARID,ARADDR,ARLEN,ARSIZE,ARVALID,ARREADY,RID,RDATA,RRESP,RLAST,RVALID,RREADY,HADDR,HBURST,HSIZE,HTRANS,HWRITE,HWDATA,HRDATA,HREADY,HRESP);
