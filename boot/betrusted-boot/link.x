MEMORY
{
  RAM : ORIGIN = 0x61009000, LENGTH = 2M - 36k  /* locate this outside of the page table area, bottom 32k for PT's and EH */
  FLASH : ORIGIN = 0x00000000, LENGTH = 4M /* tests *have* to be run in virtual memory mode. We rely on the initial code being PIC to set things up. */
