...
pub fn apb_test() {
    ...
    singlecheck("BIO_BDMA_SFR_CTRL        ", 0x50124000 as *mut u32, 0x9a238b6a);
    singlecheck("BIO_BDMA_SFR_CFGINFO     ", 0x50124004 as *mut u32, 0x1011eeb4);
    singlecheck("BIO_BDMA_SFR_CONFIG      ", 0x50124008 as *mut u32, 0x66b072b9);
    singlecheck("BIO_BDMA_SFR_FLEVEL      ", 0x5012400c as *mut u32, 0x95be4da0);
    singlecheck("BIO_BDMA_SFR_TXF0        ", 0x50124010 as *mut u32, 0x89e6156b);
    singlecheck("BIO_BDMA_SFR_TXF1        ", 0x50124014 as *mut u32, 0x70fc1afc);
    singlecheck("BIO_BDMA_SFR_TXF2        ", 0x50124018 as *mut u32, 0x00b97ea6);
    singlecheck("BIO_BDMA_SFR_TXF3        ", 0x5012401c as *mut u32, 0x89112f0a);
    singlecheck("BIO_BDMA_SFR_RXF0        ", 0x50124020 as *mut u32, 0x0cf25923);
    singlecheck("BIO_BDMA_SFR_RXF1        ", 0x50124024 as *mut u32, 0x17be082f);
    singlecheck("BIO_BDMA_SFR_RXF2        ", 0x50124028 as *mut u32, 0x7c2c966d);
    singlecheck("BIO_BDMA_SFR_RXF3        ", 0x5012402c as *mut u32, 0x72745307);
    singlecheck("BIO_BDMA_SFR_ELEVEL      ", 0x50124030 as *mut u32, 0xb9e93d52);
    singlecheck("BIO_BDMA_SFR_ETYPE       ", 0x50124034 as *mut u32, 0xb2a7a18a);
    singlecheck("BIO_BDMA_SFR_EVENT_SET   ", 0x50124038 as *mut u32, 0x6c5e1578);
    singlecheck("BIO_BDMA_SFR_EVENT_CLR   ", 0x5012403c as *mut u32, 0x3cc279b3);
    singlecheck("BIO_BDMA_SFR_EVENT_STATUS", 0x50124040 as *mut u32, 0x9e7e1fc3);
    singlecheck("BIO_BDMA_SFR_EXTCLOCK    ", 0x50124044 as *mut u32, 0xafe08a13);
    singlecheck("BIO_BDMA_SFR_FIFO_CLR    ", 0x50124048 as *mut u32, 0x7a9c0163);
    singlecheck("BIO_BDMA_SFR_QDIV0       ", 0x50124050 as *mut u32, 0xcebe24d9);
    singlecheck("BIO_BDMA_SFR_QDIV1       ", 0x50124054 as *mut u32, 0xf65cf3f3);
    singlecheck("BIO_BDMA_SFR_QDIV2       ", 0x50124058 as *mut u32, 0xdbdd4dd9);
    singlecheck("BIO_BDMA_SFR_QDIV3       ", 0x5012405c as *mut u32, 0xb7debb9b);
    singlecheck("BIO_BDMA_SFR_SYNC_BYPASS ", 0x50124060 as *mut u32, 0xe380a176);
    singlecheck("BIO_BDMA_SFR_IO_OE_INV   ", 0x50124064 as *mut u32, 0xf65e7737);
    singlecheck("BIO_BDMA_SFR_IO_O_INV    ", 0x50124068 as *mut u32, 0x491597ca);
    singlecheck("BIO_BDMA_SFR_IO_I_INV    ", 0x5012406c as *mut u32, 0xab8534c1);
    singlecheck("BIO_BDMA_SFR_IRQMASK_0   ", 0x50124070 as *mut u32, 0x242a809b);
    singlecheck("BIO_BDMA_SFR_IRQMASK_1   ", 0x50124074 as *mut u32, 0x985a9ef0);
    singlecheck("BIO_BDMA_SFR_IRQMASK_2   ", 0x50124078 as *mut u32, 0x5990fe96);
    singlecheck("BIO_BDMA_SFR_IRQMASK_3   ", 0x5012407c as *mut u32, 0x31d4ff08);
    singlecheck("BIO_BDMA_SFR_IRQ_EDGE    ", 0x50124080 as *mut u32, 0xffec35fe);
    singlecheck("BIO_BDMA_SFR_DBG_PADOUT  ", 0x50124084 as *mut u32, 0x6c69a172);
    singlecheck("BIO_BDMA_SFR_DBG_PADOE   ", 0x50124088 as *mut u32, 0x8e368ce0);
    ...
    singlecheck("SDDC_SFR_IO                                                             ", 0x50121000 as *mut u32, 0x0165f0f0);
    singlecheck("SDDC_SFR_AR                                                             ", 0x50121004 as *mut u32, 0xfaa97965);
    singlecheck("SDDC_CR_OCR                                                             ", 0x50121010 as *mut u32, 0x62a12347);
    singlecheck("SDDC_CR_RDFFTHRES                                                       ", 0x50121014 as *mut u32, 0xa9632e3d);
    singlecheck("SDDC_CR_REV                                                             ", 0x50121018 as *mut u32, 0x9fc745d0);
    singlecheck("SDDC_CR_BACSA                                                           ", 0x5012101c as *mut u32, 0xe6cc5bda);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC0                                   ", 0x50121020 as *mut u32, 0x8d3ba755);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC1                                   ", 0x50121024 as *mut u32, 0x7587e119);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC2                                   ", 0x50121028 as *mut u32, 0x55f7f60a);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC3                                   ", 0x5012102c as *mut u32, 0x08d6920b);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC4                                   ", 0x50121030 as *mut u32, 0xa0a1c6ef);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC5                                   ", 0x50121034 as *mut u32, 0x120ff957);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC6                                   ", 0x50121038 as *mut u32, 0x43eb96f3);
    singlecheck("SDDC_CR_BAIOFN_CFG_BASE_ADDR_IO_FUNC7                                   ", 0x5012103c as *mut u32, 0x2d13320e);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR0                                  ", 0x50121040 as *mut u32, 0x75f32b50);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR1                                  ", 0x50121044 as *mut u32, 0x2752aa63);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR2                                  ", 0x50121048 as *mut u32, 0x865fc874);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR3                                  ", 0x5012104c as *mut u32, 0x1ed188dc);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR4                                  ", 0x50121050 as *mut u32, 0xce80f7b1);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR5                                  ", 0x50121054 as *mut u32, 0xcf4c7d08);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR6                                  ", 0x50121058 as *mut u32, 0x93672832);
    singlecheck("SDDC_CR_FNCISPTR_CFG_REG_FUNC_CIS_PTR7                                  ", 0x5012105c as *mut u32, 0x827f9414);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE0                         ", 0x50121060 as *mut u32, 0xb68a272a);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE1                         ", 0x50121064 as *mut u32, 0xa2465d29);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE2                         ", 0x50121068 as *mut u32, 0x9bdb8549);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE3                         ", 0x5012106c as *mut u32, 0xa5748bd1);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE4                         ", 0x50121070 as *mut u32, 0x891b8273);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE5                         ", 0x50121074 as *mut u32, 0x36c35dc5);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE6                         ", 0x50121078 as *mut u32, 0x6b3d9c59);
    singlecheck("SDDC_CR_FNEXTSTDCODE_CFG_REG_FUNC_EXT_STD_CODE7                         ", 0x5012107c as *mut u32, 0xdbc1f2b0);
    singlecheck("SDDC_CR_WRITE_PROTECT                                                   ", 0x50121080 as *mut u32, 0x1d95cdb0);
    singlecheck("SDDC_CR_REG_DSR                                                         ", 0x50121084 as *mut u32, 0x4cae8b6b);
    singlecheck("SDDC_CR_REG_CID_CFG_REG_CID0                                            ", 0x50121088 as *mut u32, 0xd9e0e7fe);
    singlecheck("SDDC_CR_REG_CID_CFG_REG_CID1                                            ", 0x5012108c as *mut u32, 0xa03bdb07);
    singlecheck("SDDC_CR_REG_CID_CFG_REG_CID2                                            ", 0x50121090 as *mut u32, 0x071c80a0);
    singlecheck("SDDC_CR_REG_CID_CFG_REG_CID3                                            ", 0x50121094 as *mut u32, 0x9bfa3292);
    singlecheck("SDDC_CR_REG_CSD_CFG_REG_CSD0                                            ", 0x50121098 as *mut u32, 0xc5f0a710);
    singlecheck("SDDC_CR_REG_CSD_CFG_REG_CSD1                                            ", 0x5012109c as *mut u32, 0xab4677e9);
    singlecheck("SDDC_CR_REG_CSD_CFG_REG_CSD2                                            ", 0x501210a0 as *mut u32, 0x279ee973);
    singlecheck("SDDC_CR_REG_CSD_CFG_REG_CSD3                                            ", 0x501210a4 as *mut u32, 0x63adcdbb);
    singlecheck("SDDC_CR_REG_SCR_CFG_REG_SCR0                                            ", 0x501210a8 as *mut u32, 0x36334245);
    singlecheck("SDDC_CR_REG_SCR_CFG_REG_SCR1                                            ", 0x501210ac as *mut u32, 0x8514f49c);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS0                                ", 0x501210b0 as *mut u32, 0x8e73758e);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS1                                ", 0x501210b4 as *mut u32, 0xf044106f);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS2                                ", 0x501210b8 as *mut u32, 0x21412442);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS3                                ", 0x501210bc as *mut u32, 0x7528ffc4);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS4                                ", 0x501210c0 as *mut u32, 0xac79fc27);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS5                                ", 0x501210c4 as *mut u32, 0x859b4c3f);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS6                                ", 0x501210c8 as *mut u32, 0xc9763989);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS7                                ", 0x501210cc as *mut u32, 0xb8b00cb6);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS8                                ", 0x501210d0 as *mut u32, 0x20aa8c99);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS9                                ", 0x501210d4 as *mut u32, 0xfdcf4d10);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS10                               ", 0x501210d8 as *mut u32, 0xee412da7);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS11                               ", 0x501210dc as *mut u32, 0x6f6da855);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS12                               ", 0x501210e0 as *mut u32, 0xa8c7b926);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS13                               ", 0x501210e4 as *mut u32, 0x1731222b);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS14                               ", 0x501210e8 as *mut u32, 0x74bc1570);
    singlecheck("SDDC_CR_REG_SD_STATUS_CFG_REG_SD_STATUS15                               ", 0x501210ec as *mut u32, 0x4fb358cf);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC0                      ", 0x50121100 as *mut u32, 0xbfde6f8e);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC1                      ", 0x50121104 as *mut u32, 0x61d4c262);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC2                      ", 0x50121108 as *mut u32, 0x9925fe10);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC3                      ", 0x5012110c as *mut u32, 0xf5a31c96);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC4                      ", 0x50121110 as *mut u32, 0xfcc1650f);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC5                      ", 0x50121114 as *mut u32, 0xbfd67c42);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC6                      ", 0x50121118 as *mut u32, 0x21546acf);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC7                      ", 0x5012111c as *mut u32, 0xa8245fe4);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC8                      ", 0x50121120 as *mut u32, 0x74a8eaec);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC9                      ", 0x50121124 as *mut u32, 0x0303cd03);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC10                     ", 0x50121128 as *mut u32, 0x2bb9daa6);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC11                     ", 0x5012112c as *mut u32, 0x35322c61);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC12                     ", 0x50121130 as *mut u32, 0x557e8b56);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC13                     ", 0x50121134 as *mut u32, 0x96cd38a3);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC14                     ", 0x50121138 as *mut u32, 0x27aacf24);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC15                     ", 0x5012113c as *mut u32, 0x7c0dc237);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC16                     ", 0x50121140 as *mut u32, 0x5b066f19);
    singlecheck("SDDC_CR_BASE_ADDR_MEM_FUNC_CFG_BASE_ADDR_MEM_FUNC17                     ", 0x50121144 as *mut u32, 0x0141c505);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE0", 0x50121148 as *mut u32, 0xac981167);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE1", 0x5012114c as *mut u32, 0x0c4c3bc9);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE2", 0x50121150 as *mut u32, 0xb6cfad9e);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE3", 0x50121154 as *mut u32, 0x7593f011);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE4", 0x50121158 as *mut u32, 0xd6ba26ea);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE5", 0x5012115c as *mut u32, 0x17bb0d12);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_INTERFACE_CODE_CFG_REG_FUNC_ISDIO_INTERFACE_CODE6", 0x50121160 as *mut u32, 0x764f924c);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE0              ", 0x50121168 as *mut u32, 0x8cfd7d07);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE1              ", 0x5012116c as *mut u32, 0x9218bb1c);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE2              ", 0x50121170 as *mut u32, 0x15c19a7a);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE3              ", 0x50121174 as *mut u32, 0xf1c04236);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE4              ", 0x50121178 as *mut u32, 0xc0ca8d26);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE5              ", 0x5012117c as *mut u32, 0xd9d42713);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_CODE_CFG_REG_FUNC_MANUFACT_CODE6              ", 0x50121180 as *mut u32, 0xd0b1d953);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO0              ", 0x50121188 as *mut u32, 0x05efdd1d);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO1              ", 0x5012118c as *mut u32, 0xff5e6c3b);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO2              ", 0x50121190 as *mut u32, 0xb6307ed0);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO3              ", 0x50121194 as *mut u32, 0xb21564b9);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO4              ", 0x50121198 as *mut u32, 0xa82aed54);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO5              ", 0x5012119c as *mut u32, 0x73650b75);
    singlecheck("SDDC_CR_REG_FUNC_MANUFACT_INFO_CFG_REG_FUNC_MANUFACT_INFO6              ", 0x501211a0 as *mut u32, 0x3a0e8f7d);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE0  ", 0x501211a8 as *mut u32, 0x77bea723);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE1  ", 0x501211ac as *mut u32, 0xe8ad5157);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE2  ", 0x501211b0 as *mut u32, 0x8b60b627);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE3  ", 0x501211b4 as *mut u32, 0xd0c42bcf);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE4  ", 0x501211b8 as *mut u32, 0x4dad91a9);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE5  ", 0x501211bc as *mut u32, 0x3c01a871);
    singlecheck("SDDC_CR_REG_FUNC_ISDIO_TYPE_SUP_CODE_CFG_REG_FUNC_ISDIO_TYPE_SUP_CODE6  ", 0x501211c0 as *mut u32, 0x084b4fbc);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO0                                ", 0x501211c8 as *mut u32, 0x2a1a82c6);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO1                                ", 0x501211cc as *mut u32, 0x4ebba1e3);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO2                                ", 0x501211d0 as *mut u32, 0xc493daeb);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO3                                ", 0x501211d4 as *mut u32, 0x07462357);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO4                                ", 0x501211d8 as *mut u32, 0x778abe27);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO5                                ", 0x501211dc as *mut u32, 0x3ed664db);
    singlecheck("SDDC_CR_REG_FUNC_INFO_CFG_REG_FUNC_INFO6                                ", 0x501211e0 as *mut u32, 0x046cbf22);
    singlecheck("SDDC_CR_REG_UHS_1_SUPPORT                                               ", 0x501211f0 as *mut u32, 0xadeb2fa9);
