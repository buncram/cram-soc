...
mod tests {
    ...
    fn compile_check_sce_glbsfr_csr() {
        ...
        let foo = sce_glbsfr_csr.r(utra::sce_glbsfr::RESERVED8);
        sce_glbsfr_csr.wo(utra::sce_glbsfr::RESERVED8, foo);
        let bar = sce_glbsfr_csr.rf(utra::sce_glbsfr::RESERVED8_RESERVED8);
        sce_glbsfr_csr.rmwf(utra::sce_glbsfr::RESERVED8_RESERVED8, bar);
        let mut baz = sce_glbsfr_csr.zf(utra::sce_glbsfr::RESERVED8_RESERVED8, bar);
        baz |= sce_glbsfr_csr.ms(utra::sce_glbsfr::RESERVED8_RESERVED8, 1);
        sce_glbsfr_csr.wfo(utra::sce_glbsfr::RESERVED8_RESERVED8, baz);

        let foo = sce_glbsfr_csr.r(utra::sce_glbsfr::RESERVED9);
        sce_glbsfr_csr.wo(utra::sce_glbsfr::RESERVED9, foo);
        let bar = sce_glbsfr_csr.rf(utra::sce_glbsfr::RESERVED9_RESERVED9);
        sce_glbsfr_csr.rmwf(utra::sce_glbsfr::RESERVED9_RESERVED9, bar);
        let mut baz = sce_glbsfr_csr.zf(utra::sce_glbsfr::RESERVED9_RESERVED9, bar);
        baz |= sce_glbsfr_csr.ms(utra::sce_glbsfr::RESERVED9_RESERVED9, 1);
        sce_glbsfr_csr.wfo(utra::sce_glbsfr::RESERVED9_RESERVED9, baz);
