//--------------------------------------------------------------------------------
// Auto-generated by sce_to_svd (derived from LiteX) (840aa86b) on 2023-03-21 16:01:09
//--------------------------------------------------------------------------------
...
#define CSR_AES_SFR_OPT_ADDR (CSR_BASE + 0x4L)
...
#define CSR_AES_SFR_OPT1_ADDR (CSR_BASE + 0x8L)
...
#define CSR_AES_SFR_SEGPTR_PTRID_AKEY_ADDR (CSR_BASE + 0xcL)
...
#define CSR_AES_SFR_SEGPTR_PTRID_AIB_ADDR (CSR_BASE + 0x10L)
...
#define CSR_AES_SFR_SEGPTR_PTRID_IV_ADDR (CSR_BASE + 0x14L)
...
#define CSR_AES_SFR_SEGPTR_PTRID_AOB_ADDR (CSR_BASE + 0x18L)
...
#define CSR_AES_SFR_SRMFSM_ADDR (CSR_BASE + 0x1cL)
...
#define CSR_AES_SFR_FR_ADDR (CSR_BASE + 0x20L)
...
#define CSR_AES_SFR_AR_ADDR (CSR_BASE + 0x24L)
...
#define CSR_COMBOHASH_SFR_OPT1_ADDR (CSR_BASE + -0x1ffcL)
...
#define CSR_COMBOHASH_SFR_OPT2_ADDR (CSR_BASE + -0x1ff8L)
...
static inline void combohash_sfr_opt2_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0x1ff8L));
}
...
#define CSR_COMBOHASH_SFR_SEGPTR_SEGID_HOUT_ADDR (CSR_BASE + -0x1ff4L)
...
static inline void combohash_sfr_segptr_SEGID_HOUT_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0x1ff4L));
}
...
#define CSR_COMBOHASH_SFR_SEGPTR_SEGID_LKEY_ADDR (CSR_BASE + -0x1ff0L)
...
#define CSR_COMBOHASH_SFR_SEGPTR_SEGID_MSG_ADDR (CSR_BASE + -0x1fecL)
...
#define CSR_COMBOHASH_SFR_SEGPTR_SEGID_KEY_ADDR (CSR_BASE + -0x1fe8L)
...
#define CSR_COMBOHASH_SFR_SEGPTR_SEGID_SCRT_ADDR (CSR_BASE + -0x1fe4L)
...
#define CSR_COMBOHASH_SFR_SEGPTR_SEGID_SOB_ADDR (CSR_BASE + -0x1fe0L)
...
#define CSR_COMBOHASH_SFR_SRMFSM_ADDR (CSR_BASE + -0x1fdcL)
...
#define CSR_COMBOHASH_SFR_FR_ADDR (CSR_BASE + -0x1fd8L)
...
#define CSR_COMBOHASH_SFR_AR_ADDR (CSR_BASE + -0x1fd4L)
...
#define CSR_PKE_SFR_OPTNW_ADDR (CSR_BASE + -0xffcL)
...
#define CSR_PKE_SFR_OPTEW_ADDR (CSR_BASE + -0xff8L)
...
static inline void pke_sfr_optew_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0xff8L));
}
...
#define CSR_PKE_SFR_OPTMASK_ADDR (CSR_BASE + -0xff4L)
...
static inline void pke_sfr_optmask_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0xff4L));
}
...
#define CSR_PKE_SFR_SEGPTR_PTRID_PIB0_ADDR (CSR_BASE + -0xff0L)
...
#define CSR_PKE_SFR_SEGPTR_PTRID_PIB1_ADDR (CSR_BASE + -0xfecL)
...
#define CSR_PKE_SFR_SEGPTR_PTRID_PKB_ADDR (CSR_BASE + -0xfe8L)
...
#define CSR_PKE_SFR_SEGPTR_PTRID_PCON_ADDR (CSR_BASE + -0xfe4L)
...
#define CSR_PKE_SFR_SEGPTR_PTRID_POB_ADDR (CSR_BASE + -0xfe0L)
...
#define CSR_PKE_SFR_SRMFSM_ADDR (CSR_BASE + -0xfdcL)
...
#define CSR_PKE_SFR_FR_ADDR (CSR_BASE + -0xfd8L)
...
#define CSR_PKE_SFR_AR_ADDR (CSR_BASE + -0xfd4L)
...
#define CSR_SCEDMA_SFR_XCH_FUNC_ADDR (CSR_BASE + -0x4000L)
...
#define CSR_SCEDMA_SFR_XCH_OPT_ADDR (CSR_BASE + -0x3ffcL)
...
#define CSR_SCEDMA_SFR_XCH_AXSTART_ADDR (CSR_BASE + -0x3ff8L)
...
#define CSR_SCEDMA_SFR_XCH_SEGID_ADDR (CSR_BASE + -0x3ff4L)
...
#define CSR_SCEDMA_SFR_XCH_SEGSTART_ADDR (CSR_BASE + -0x3ff0L)
...
#define CSR_SCEDMA_SFR_XCH_TRANSIZE_ADDR (CSR_BASE + -0x3fecL)
...
#define CSR_SCEDMA_SFR_SCH_FUNC_ADDR (CSR_BASE + -0x3fe8L)
...
#define CSR_SCEDMA_SFR_SCH_OPT_ADDR (CSR_BASE + -0x3fe4L)
...
#define CSR_SCEDMA_SFR_SCH_AXSTART_ADDR (CSR_BASE + -0x3fe0L)
...
#define CSR_SCEDMA_SFR_SCH_SEGID_ADDR (CSR_BASE + -0x3fdcL)
...
#define CSR_SCEDMA_SFR_SCH_SEGSTART_ADDR (CSR_BASE + -0x3fd8L)
...
#define CSR_SCEDMA_SFR_SCH_TRANSIZE_ADDR (CSR_BASE + -0x3fd4L)
...
#define CSR_SCEDMA_SFR_ICH_OPT_ADDR (CSR_BASE + -0x3fd0L)
...
#define CSR_SCEDMA_SFR_ICH_SEGID_ADDR (CSR_BASE + -0x3fccL)
...
#define CSR_SCEDMA_SFR_ICH_RPSTART_ADDR (CSR_BASE + -0x3fc8L)
...
#define CSR_SCEDMA_SFR_ICH_WPSTART_ADDR (CSR_BASE + -0x3fc4L)
...
#define CSR_SCEDMA_SFR_ICH_TRANSIZE_ADDR (CSR_BASE + -0x3fc0L)
...
#define CSR_SCEDMA_SFR_ICHSTART_AR_ADDR (CSR_BASE + -0x3fbcL)
#define CSR_SCEDMA_SFR_ICHSTART_AR_SIZE 1
static inline uint32_t scedma_sfr_ichstart_ar_read(void) {
	return csr_read_simple((CSR_BASE + -0x3fbcL));
}
static inline void scedma_sfr_ichstart_ar_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0x3fbcL));
}
#define CSR_SCEDMA_SFR_ICHSTART_AR_SFR_ICHSTART_AR_OFFSET 0
#define CSR_SCEDMA_SFR_ICHSTART_AR_SFR_ICHSTART_AR_SIZE 32
static inline uint32_t scedma_sfr_ichstart_ar_sfr_ichstart_ar_extract(uint32_t oldword) {
	uint32_t mask = 0xffffffff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t scedma_sfr_ichstart_ar_sfr_ichstart_ar_read(void) {
	uint32_t word = scedma_sfr_ichstart_ar_read();
	return scedma_sfr_ichstart_ar_sfr_ichstart_ar_extract(word);
}
static inline uint32_t scedma_sfr_ichstart_ar_sfr_ichstart_ar_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xffffffff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void scedma_sfr_ichstart_ar_sfr_ichstart_ar_write(uint32_t plain_value) {
	uint32_t oldword = scedma_sfr_ichstart_ar_read();
	uint32_t newword = scedma_sfr_ichstart_ar_sfr_ichstart_ar_replace(oldword, plain_value);
	scedma_sfr_ichstart_ar_write(newword);
}
#define CSR_SCEDMA_SFR_XCHSTART_AR_ADDR (CSR_BASE + -0x3fb8L)
#define CSR_SCEDMA_SFR_XCHSTART_AR_SIZE 1
static inline uint32_t scedma_sfr_xchstart_ar_read(void) {
	return csr_read_simple((CSR_BASE + -0x3fb8L));
}
static inline void scedma_sfr_xchstart_ar_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0x3fb8L));
}
#define CSR_SCEDMA_SFR_XCHSTART_AR_SFR_XCHSTART_AR_OFFSET 0
#define CSR_SCEDMA_SFR_XCHSTART_AR_SFR_XCHSTART_AR_SIZE 32
static inline uint32_t scedma_sfr_xchstart_ar_sfr_xchstart_ar_extract(uint32_t oldword) {
	uint32_t mask = 0xffffffff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t scedma_sfr_xchstart_ar_sfr_xchstart_ar_read(void) {
	uint32_t word = scedma_sfr_xchstart_ar_read();
	return scedma_sfr_xchstart_ar_sfr_xchstart_ar_extract(word);
}
static inline uint32_t scedma_sfr_xchstart_ar_sfr_xchstart_ar_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xffffffff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void scedma_sfr_xchstart_ar_sfr_xchstart_ar_write(uint32_t plain_value) {
	uint32_t oldword = scedma_sfr_xchstart_ar_read();
	uint32_t newword = scedma_sfr_xchstart_ar_sfr_xchstart_ar_replace(oldword, plain_value);
	scedma_sfr_xchstart_ar_write(newword);
}
#define CSR_SCEDMA_SFR_SCHSTART_AR_ADDR (CSR_BASE + -0x3fb4L)
...
#define CSR_SCE_GLBSFR_SFR_FFEN_ADDR (CSR_BASE + -0x4ff4L)
...
#define CSR_SCE_GLBSFR_SFR_FFCNT_SR_FF0_ADDR (CSR_BASE + -0x4fecL)
...
#define CSR_SCE_GLBSFR_SFR_FFCNT_SR_FF1_ADDR (CSR_BASE + -0x4fe8L)
...
#define CSR_SCE_GLBSFR_SFR_FFCNT_SR_FF2_ADDR (CSR_BASE + -0x4fe4L)
...
#define CSR_SCE_GLBSFR_SFR_FFCNT_SR_FF3_ADDR (CSR_BASE + -0x4fe0L)
...
#define CSR_SCE_GLBSFR_SFR_FFCNT_SR_FF4_ADDR (CSR_BASE + -0x4fdcL)
...
#define CSR_SCE_GLBSFR_SFR_FFCNT_SR_FF5_ADDR (CSR_BASE + -0x4fd8L)
...
#define CSR_SCE_GLBSFR_SFR_FRDONE_ADDR (CSR_BASE + -0x4fd4L)
...
#define CSR_SCE_GLBSFR_SFR_FRERR_ADDR (CSR_BASE + -0x4fd0L)
...
#define CSR_SCE_GLBSFR_SFR_ARRST_ADDR (CSR_BASE + -0x4fccL)
#define CSR_SCE_GLBSFR_SFR_ARRST_SIZE 1
static inline uint32_t sce_glbsfr_sfr_arrst_read(void) {
	return csr_read_simple((CSR_BASE + -0x4fccL));
}
static inline void sce_glbsfr_sfr_arrst_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + -0x4fccL));
}
#define CSR_SCE_GLBSFR_SFR_ARRST_AR_RESET_OFFSET 0
#define CSR_SCE_GLBSFR_SFR_ARRST_AR_RESET_SIZE 32
static inline uint32_t sce_glbsfr_sfr_arrst_ar_reset_extract(uint32_t oldword) {
	uint32_t mask = 0xffffffff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t sce_glbsfr_sfr_arrst_ar_reset_read(void) {
	uint32_t word = sce_glbsfr_sfr_arrst_read();
	return sce_glbsfr_sfr_arrst_ar_reset_extract(word);
}
static inline uint32_t sce_glbsfr_sfr_arrst_ar_reset_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xffffffff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void sce_glbsfr_sfr_arrst_ar_reset_write(uint32_t plain_value) {
	uint32_t oldword = sce_glbsfr_sfr_arrst_read();
	uint32_t newword = sce_glbsfr_sfr_arrst_ar_reset_replace(oldword, plain_value);
	sce_glbsfr_sfr_arrst_write(newword);
}
#define CSR_SCE_GLBSFR_SFR_ARCLR_ADDR (CSR_BASE + -0x4fc8L)
...
#define CSR_SCE_GLBSFR_SFR_FFCLR_ADDR (CSR_BASE + -0x4fc4L)
