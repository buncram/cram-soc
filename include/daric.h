//--------------------------------------------------------------------------------
// Auto-generated by sce_to_svd (derived from LiteX) (e08384a2) on 2023-07-17 16:36:29
//--------------------------------------------------------------------------------
...
#define CSR_TRNG_SFR_CRFUNC_ADDR (CSR_BASE + 0x1000L)
#define CSR_TRNG_SFR_CRFUNC_SIZE 1
static inline uint32_t trng_sfr_crfunc_read(void) {
	return csr_read_simple((CSR_BASE + 0x1000L));
}
static inline void trng_sfr_crfunc_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1000L));
}
#define CSR_TRNG_SFR_CRFUNC_CR_FUNC_OFFSET 0
#define CSR_TRNG_SFR_CRFUNC_CR_FUNC_SIZE 8
static inline uint32_t trng_sfr_crfunc_cr_func_extract(uint32_t oldword) {
	uint32_t mask = 0xff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_crfunc_cr_func_read(void) {
	uint32_t word = trng_sfr_crfunc_read();
	return trng_sfr_crfunc_cr_func_extract(word);
}
static inline uint32_t trng_sfr_crfunc_cr_func_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_crfunc_cr_func_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_crfunc_read();
	uint32_t newword = trng_sfr_crfunc_cr_func_replace(oldword, plain_value);
	trng_sfr_crfunc_write(newword);
}
#define CSR_TRNG_SFR_AR_ADDR (CSR_BASE + 0x1004L)
#define CSR_TRNG_SFR_AR_SIZE 1
static inline uint32_t trng_sfr_ar_read(void) {
	return csr_read_simple((CSR_BASE + 0x1004L));
}
static inline void trng_sfr_ar_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1004L));
}
#define CSR_TRNG_SFR_AR_START_OFFSET 0
#define CSR_TRNG_SFR_AR_START_SIZE 32
static inline uint32_t trng_sfr_ar_start_extract(uint32_t oldword) {
	uint32_t mask = 0xffffffff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_ar_start_read(void) {
	uint32_t word = trng_sfr_ar_read();
	return trng_sfr_ar_start_extract(word);
}
static inline uint32_t trng_sfr_ar_start_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xffffffff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_ar_start_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_ar_read();
	uint32_t newword = trng_sfr_ar_start_replace(oldword, plain_value);
	trng_sfr_ar_write(newword);
}
#define CSR_TRNG_SFR_SRMFSM_ADDR (CSR_BASE + 0x1008L)
#define CSR_TRNG_SFR_SRMFSM_SIZE 1
static inline uint32_t trng_sfr_srmfsm_read(void) {
	return csr_read_simple((CSR_BASE + 0x1008L));
}
#define CSR_TRNG_SFR_SRMFSM_MFSM_OFFSET 0
#define CSR_TRNG_SFR_SRMFSM_MFSM_SIZE 1
static inline uint32_t trng_sfr_srmfsm_mfsm_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_srmfsm_mfsm_read(void) {
	uint32_t word = trng_sfr_srmfsm_read();
	return trng_sfr_srmfsm_mfsm_extract(word);
}
#define CSR_TRNG_SFR_SRMFSM_MODINVREADY_OFFSET 1
#define CSR_TRNG_SFR_SRMFSM_MODINVREADY_SIZE 1
static inline uint32_t trng_sfr_srmfsm_modinvready_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 1) & mask );
}
static inline uint32_t trng_sfr_srmfsm_modinvready_read(void) {
	uint32_t word = trng_sfr_srmfsm_read();
	return trng_sfr_srmfsm_modinvready_extract(word);
}
#define CSR_TRNG_SFR_FR_ADDR (CSR_BASE + 0x100cL)
#define CSR_TRNG_SFR_FR_SIZE 1
static inline uint32_t trng_sfr_fr_read(void) {
	return csr_read_simple((CSR_BASE + 0x100cL));
}
#define CSR_TRNG_SFR_FR_MFSM_DONE_OFFSET 0
#define CSR_TRNG_SFR_FR_MFSM_DONE_SIZE 1
static inline uint32_t trng_sfr_fr_mfsm_done_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_fr_mfsm_done_read(void) {
	uint32_t word = trng_sfr_fr_read();
	return trng_sfr_fr_mfsm_done_extract(word);
}
#define CSR_TRNG_SFR_FR_PCORE_DONE_OFFSET 1
#define CSR_TRNG_SFR_FR_PCORE_DONE_SIZE 1
static inline uint32_t trng_sfr_fr_pcore_done_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 1) & mask );
}
static inline uint32_t trng_sfr_fr_pcore_done_read(void) {
	uint32_t word = trng_sfr_fr_read();
	return trng_sfr_fr_pcore_done_extract(word);
}
#define CSR_TRNG_SFR_FR_CHNLO_DONE_OFFSET 2
#define CSR_TRNG_SFR_FR_CHNLO_DONE_SIZE 1
static inline uint32_t trng_sfr_fr_chnlo_done_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 2) & mask );
}
static inline uint32_t trng_sfr_fr_chnlo_done_read(void) {
	uint32_t word = trng_sfr_fr_read();
	return trng_sfr_fr_chnlo_done_extract(word);
}
#define CSR_TRNG_SFR_FR_CHNLI_DONE_OFFSET 3
#define CSR_TRNG_SFR_FR_CHNLI_DONE_SIZE 1
static inline uint32_t trng_sfr_fr_chnli_done_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 3) & mask );
}
static inline uint32_t trng_sfr_fr_chnli_done_read(void) {
	uint32_t word = trng_sfr_fr_read();
	return trng_sfr_fr_chnli_done_extract(word);
}
#define CSR_TRNG_SFR_FR_CHNLX_DONE_OFFSET 4
#define CSR_TRNG_SFR_FR_CHNLX_DONE_SIZE 1
static inline uint32_t trng_sfr_fr_chnlx_done_extract(uint32_t oldword) {
	uint32_t mask = 0x1;
	return ( (oldword >> 4) & mask );
}
static inline uint32_t trng_sfr_fr_chnlx_done_read(void) {
	uint32_t word = trng_sfr_fr_read();
	return trng_sfr_fr_chnlx_done_extract(word);
}
#define CSR_TRNG_SFR_OPTNW_ADDR (CSR_BASE + 0x1010L)
#define CSR_TRNG_SFR_OPTNW_SIZE 1
static inline uint32_t trng_sfr_optnw_read(void) {
	return csr_read_simple((CSR_BASE + 0x1010L));
}
static inline void trng_sfr_optnw_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1010L));
}
#define CSR_TRNG_SFR_OPTNW_OPT_NW_OFFSET 0
#define CSR_TRNG_SFR_OPTNW_OPT_NW_SIZE 13
static inline uint32_t trng_sfr_optnw_opt_nw_extract(uint32_t oldword) {
	uint32_t mask = 0x1fff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_optnw_opt_nw_read(void) {
	uint32_t word = trng_sfr_optnw_read();
	return trng_sfr_optnw_opt_nw_extract(word);
}
static inline uint32_t trng_sfr_optnw_opt_nw_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0x1fff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_optnw_opt_nw_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_optnw_read();
	uint32_t newword = trng_sfr_optnw_opt_nw_replace(oldword, plain_value);
	trng_sfr_optnw_write(newword);
}
#define CSR_TRNG_SFR_OPTEW_ADDR (CSR_BASE + 0x1014L)
#define CSR_TRNG_SFR_OPTEW_SIZE 1
static inline uint32_t trng_sfr_optew_read(void) {
	return csr_read_simple((CSR_BASE + 0x1014L));
}
static inline void trng_sfr_optew_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1014L));
}
#define CSR_TRNG_SFR_OPTEW_OPT_EW_OFFSET 0
#define CSR_TRNG_SFR_OPTEW_OPT_EW_SIZE 13
static inline uint32_t trng_sfr_optew_opt_ew_extract(uint32_t oldword) {
	uint32_t mask = 0x1fff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_optew_opt_ew_read(void) {
	uint32_t word = trng_sfr_optew_read();
	return trng_sfr_optew_opt_ew_extract(word);
}
static inline uint32_t trng_sfr_optew_opt_ew_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0x1fff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_optew_opt_ew_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_optew_read();
	uint32_t newword = trng_sfr_optew_opt_ew_replace(oldword, plain_value);
	trng_sfr_optew_write(newword);
}
#define CSR_TRNG_SFR_OPTMASK_ADDR (CSR_BASE + 0x1020L)
#define CSR_TRNG_SFR_OPTMASK_SIZE 1
static inline uint32_t trng_sfr_optmask_read(void) {
	return csr_read_simple((CSR_BASE + 0x1020L));
}
static inline void trng_sfr_optmask_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1020L));
}
#define CSR_TRNG_SFR_OPTMASK_OPT_MASK_OFFSET 0
#define CSR_TRNG_SFR_OPTMASK_OPT_MASK_SIZE 16
static inline uint32_t trng_sfr_optmask_opt_mask_extract(uint32_t oldword) {
	uint32_t mask = 0xffff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_optmask_opt_mask_read(void) {
	uint32_t word = trng_sfr_optmask_read();
	return trng_sfr_optmask_opt_mask_extract(word);
}
static inline uint32_t trng_sfr_optmask_opt_mask_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xffff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_optmask_opt_mask_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_optmask_read();
	uint32_t newword = trng_sfr_optmask_opt_mask_replace(oldword, plain_value);
	trng_sfr_optmask_write(newword);
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART0_ADDR (CSR_BASE + 0x1030L)
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART0_SIZE 1
static inline uint32_t trng_sfr_segptr_cr_segptrstart0_read(void) {
	return csr_read_simple((CSR_BASE + 0x1030L));
}
static inline void trng_sfr_segptr_cr_segptrstart0_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1030L));
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART0_CR_SEGPTRSTART0_OFFSET 0
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART0_CR_SEGPTRSTART0_SIZE 12
static inline uint32_t trng_sfr_segptr_cr_segptrstart0_cr_segptrstart0_extract(uint32_t oldword) {
	uint32_t mask = 0xfff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart0_cr_segptrstart0_read(void) {
	uint32_t word = trng_sfr_segptr_cr_segptrstart0_read();
	return trng_sfr_segptr_cr_segptrstart0_cr_segptrstart0_extract(word);
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart0_cr_segptrstart0_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xfff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_segptr_cr_segptrstart0_cr_segptrstart0_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_segptr_cr_segptrstart0_read();
	uint32_t newword = trng_sfr_segptr_cr_segptrstart0_cr_segptrstart0_replace(oldword, plain_value);
	trng_sfr_segptr_cr_segptrstart0_write(newword);
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART1_ADDR (CSR_BASE + 0x1034L)
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART1_SIZE 1
static inline uint32_t trng_sfr_segptr_cr_segptrstart1_read(void) {
	return csr_read_simple((CSR_BASE + 0x1034L));
}
static inline void trng_sfr_segptr_cr_segptrstart1_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1034L));
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART1_CR_SEGPTRSTART1_OFFSET 0
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART1_CR_SEGPTRSTART1_SIZE 12
static inline uint32_t trng_sfr_segptr_cr_segptrstart1_cr_segptrstart1_extract(uint32_t oldword) {
	uint32_t mask = 0xfff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart1_cr_segptrstart1_read(void) {
	uint32_t word = trng_sfr_segptr_cr_segptrstart1_read();
	return trng_sfr_segptr_cr_segptrstart1_cr_segptrstart1_extract(word);
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart1_cr_segptrstart1_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xfff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_segptr_cr_segptrstart1_cr_segptrstart1_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_segptr_cr_segptrstart1_read();
	uint32_t newword = trng_sfr_segptr_cr_segptrstart1_cr_segptrstart1_replace(oldword, plain_value);
	trng_sfr_segptr_cr_segptrstart1_write(newword);
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART2_ADDR (CSR_BASE + 0x1038L)
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART2_SIZE 1
static inline uint32_t trng_sfr_segptr_cr_segptrstart2_read(void) {
	return csr_read_simple((CSR_BASE + 0x1038L));
}
static inline void trng_sfr_segptr_cr_segptrstart2_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1038L));
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART2_CR_SEGPTRSTART2_OFFSET 0
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART2_CR_SEGPTRSTART2_SIZE 12
static inline uint32_t trng_sfr_segptr_cr_segptrstart2_cr_segptrstart2_extract(uint32_t oldword) {
	uint32_t mask = 0xfff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart2_cr_segptrstart2_read(void) {
	uint32_t word = trng_sfr_segptr_cr_segptrstart2_read();
	return trng_sfr_segptr_cr_segptrstart2_cr_segptrstart2_extract(word);
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart2_cr_segptrstart2_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xfff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_segptr_cr_segptrstart2_cr_segptrstart2_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_segptr_cr_segptrstart2_read();
	uint32_t newword = trng_sfr_segptr_cr_segptrstart2_cr_segptrstart2_replace(oldword, plain_value);
	trng_sfr_segptr_cr_segptrstart2_write(newword);
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART3_ADDR (CSR_BASE + 0x103cL)
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART3_SIZE 1
static inline uint32_t trng_sfr_segptr_cr_segptrstart3_read(void) {
	return csr_read_simple((CSR_BASE + 0x103cL));
}
static inline void trng_sfr_segptr_cr_segptrstart3_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x103cL));
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART3_CR_SEGPTRSTART3_OFFSET 0
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART3_CR_SEGPTRSTART3_SIZE 12
static inline uint32_t trng_sfr_segptr_cr_segptrstart3_cr_segptrstart3_extract(uint32_t oldword) {
	uint32_t mask = 0xfff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart3_cr_segptrstart3_read(void) {
	uint32_t word = trng_sfr_segptr_cr_segptrstart3_read();
	return trng_sfr_segptr_cr_segptrstart3_cr_segptrstart3_extract(word);
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart3_cr_segptrstart3_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xfff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_segptr_cr_segptrstart3_cr_segptrstart3_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_segptr_cr_segptrstart3_read();
	uint32_t newword = trng_sfr_segptr_cr_segptrstart3_cr_segptrstart3_replace(oldword, plain_value);
	trng_sfr_segptr_cr_segptrstart3_write(newword);
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART4_ADDR (CSR_BASE + 0x1040L)
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART4_SIZE 1
static inline uint32_t trng_sfr_segptr_cr_segptrstart4_read(void) {
	return csr_read_simple((CSR_BASE + 0x1040L));
}
static inline void trng_sfr_segptr_cr_segptrstart4_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1040L));
}
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART4_CR_SEGPTRSTART4_OFFSET 0
#define CSR_TRNG_SFR_SEGPTR_CR_SEGPTRSTART4_CR_SEGPTRSTART4_SIZE 12
static inline uint32_t trng_sfr_segptr_cr_segptrstart4_cr_segptrstart4_extract(uint32_t oldword) {
	uint32_t mask = 0xfff;
	return ( (oldword >> 0) & mask );
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart4_cr_segptrstart4_read(void) {
	uint32_t word = trng_sfr_segptr_cr_segptrstart4_read();
	return trng_sfr_segptr_cr_segptrstart4_cr_segptrstart4_extract(word);
}
static inline uint32_t trng_sfr_segptr_cr_segptrstart4_cr_segptrstart4_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = 0xfff;
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void trng_sfr_segptr_cr_segptrstart4_cr_segptrstart4_write(uint32_t plain_value) {
	uint32_t oldword = trng_sfr_segptr_cr_segptrstart4_read();
	uint32_t newword = trng_sfr_segptr_cr_segptrstart4_cr_segptrstart4_replace(oldword, plain_value);
	trng_sfr_segptr_cr_segptrstart4_write(newword);
}
...
/* pl230_placeholder */
#define CSR_PL230_PLACEHOLDER_BASE (CSR_BASE + -0x1c000L)
