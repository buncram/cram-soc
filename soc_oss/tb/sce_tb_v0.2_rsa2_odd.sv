...
//        .clkpke(clk),
  ...
  //  ==
    ...
    `maintest( sce_tb_rsabypass, sce_tb_rsabypass)
        resetn = 0;
        #( 2 `US );
        resetn = 1;
        #( 2 `US );
...
`endif
        ...
        $display("\n@I:: RSAMM 92 zero padding normal mode");
        sfrwr( GLB_suben,'1 );
        ...
        $display("\n@I:: RSAMM 92 zero padding bypass mode");
        sfrwr( GLB_suben,'1 );
        sfrwr( PKE_optnw, 32'd92);
        ...
        //N the modulo for RSA, product of two large prime
        membuf[0:3] = {32'h1,32'h0, 32'h0eef9527, 32'h0};
        memwr('h1100,4);

        //H, to fill the remaining position, need to summarize the pattern, H = 1 << NLen
        membuf[0:3] = {32'h00000000,32'h00000000,32'h10000000,32'h0};
        memwr('h1500,4);
        ...
        //X
          ...
          memwr('h1000, 4);
        // Y
        membuf[0:3] ={32'hbeca7319,32'hbeca7319, 32'h00487209,32'h0};
        memwr('h1400, 4);
