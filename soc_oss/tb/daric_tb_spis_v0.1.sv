...
module daric_top_tb ();
    ...
    logic            sclk, sclken=0;
    logic            scsn=0, scsnp;
    logic            smosi, cpol = 0, cpha = 0;
    logic            smiso;
    logic [7:0] spimdatbuf;
    logic  smosi_cpha1, smosi_cpha0;
    logic [19:0] sbitcnt;
    ...
    assign net_sclk = sclk;
    assign net_scsn = scsn;
    assign net_smosi = smosi;
    assign smiso = net_smiso;
...
/*
    ...
    ioif iopad_F[0: 5]();
*/
    bit clk32k, clk32m, clk24m, clk48m;
...
//    assign dut.PA0 = pulse1Mwire;
  ...
  //  ==
    ...
    `theregfull( sclkp, ~scsn, spimdatbuf,  mdat[midx] ) <= ( sbitcnt[2:0]==7 ) ? (( sbitcnt[19:3]<cfgrxcnt-1 ) ? mdat[midx] : '1 )  : spimdatbuf*2;
    `theregfull( sclk , ~scsn, smosi_cpha1, '1  ) <= spimdatbuf[7];
    assign smosi_cpha0 = spimdatbuf[7];
    assign smosi = cpha ? smosi_cpha1 : smosi_cpha0;
    ...
    initial begin
        ...
        #( 5 `MS ) resetn = 1;
        scsn = '1;
        cfgrxcnt = 4; cfgdmcnt = 2; cfgtxcnt = 8;
        spim();
