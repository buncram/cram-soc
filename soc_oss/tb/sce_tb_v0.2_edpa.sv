...
//        .clkpke(clk),
    ...
    assign probe_pkeram_18d = (sce_tb_edpa.dut.pke.ramadd0[8:0] == 'h18d);

  assign probe_pkeram_14a = (sce_tb_edpa.dut.pke.ramadd0[8:0] == 'h14a);
    //assign probe_pkeram_14c = (sce_tb_edpa.dut.pke.ramadd0[8:0] == 'h18c) && ;
  ...
  //  ==
    ...
    `maintest(sce_tb_edpa,sce_tb_edpa)
        resetn = 0;
        #( 2 `US );
        resetn = 1;
        #( 2 `US );
...
//@::memrd:: 0480 ->  d3f8e25c ac62485f 81624886 63439819 3edac83a 1ff4ae74 22928f49 67ae9c4a 78f5b4d4 02c36848 67240304 9f16ec17 60269ef7 a126a18e 77ee69ab 1267b1d1
//RSAME 64
     /*
    #( 10 `US );
