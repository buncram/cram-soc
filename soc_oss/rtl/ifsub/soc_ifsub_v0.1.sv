...
//    apb_mux 
    ...
    apbs_nulls #(.SLVCNT(12))uapbpernull (.apbslave(apbper[3:14]) );
...
//
    ...
    assign ifsubevo[IFEVCNT-1:0] = udmairq;
    assign ifsubevo[IFEVCNT+3:IFEVCNT] = pwmev;
    assign ifsubevo[IFEVCNT+4] = ioxirq;
    assign ifsubevo[EVCNT-1:IFEVCNT+5] = '0 | { sddcirq, usbirq };
    assign ifsuberro = '0;
...
//
        ...
        ioif      scif_sck();
        ioif      scif_dat();
        ioif      spis_clk[N_SPIS-1:0]();
        ioif      spis_csn[N_SPIS-1:0]();
        ioif      spis_mosi[N_SPIS-1:0]();
        ioif      spis_miso[N_SPIS-1:0]();
...
//
    ...
    ioif af1_B[0:15](), af2_B[0:15](), af3_B[0:15]();
    ioif af1_C[0:15](), af2_C[0:15](), af3_C[0:15]();
    ...
    iothrus ioga1B(.ioload(af1_B), .iodrv(af1[16:31]));
    iothrus ioga1C(.ioload(af1_C), .iodrv(af1[32:47]));
...
afconn afc_C06(.afomask( afom_C[6] ), .afo1( af1_C[6] ), .afo2( af2_C[6] ), .afo3( af3_C[6] ), .afi1( afnc ), .afi2( i2c_sda_b[3] ), .afi3( afnc ));
afconn afc_C07(.afomask( afom_C[7] ), .afo1( af1_C[7] ), .afo2( af2_C[7] ), .afo3( af3_C[7] ), .afi1( spim_sd0_a[1] ), .afi2( afnc ), .afi3( afnc ));
afconn afc_C08(.afomask( afom_C[8] ), .afo1( af1_C[8] ), .afo2( af2_C[8] ), .afo3( af3_C[8] ), .afi1( spim_sd1_a[1] ), .afi2( afnc ), .afi3( afnc ));
afconn afc_C09(.afomask( afom_C[9] ), .afo1( af1_C[9] ), .afo2( af2_C[9] ), .afo3( af3_C[9] ), .afi1( spim_sd2_a[1] ), .afi2( afnc ), .afi3( afnc ));
afconn afc_C10(.afomask( afom_C[10] ), .afo1( af1_C[10] ), .afo2( af2_C[10] ), .afo3( af3_C[10] ), .afi1( spim_sd3_a[1] ), .afi2( afnc ), .afi3( afnc ));
afconn afc_C11(.afomask( afom_C[11] ), .afo1( af1_C[11] ), .afo2( af2_C[11] ), .afo3( af3_C[11] ), .afi1( spim_clk_a[1] ), .afi2( afnc ), .afi3( afnc ));
afconn afc_C12(.afomask( afom_C[12] ), .afo1( af1_C[12] ), .afo2( af2_C[12] ), .afo3( af3_C[12] ), .afi1( spim_csn0_a[1] ), .afi2( afnc ), .afi3( afnc ));
