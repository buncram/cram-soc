...
//    localparam N_SPIS = 1;
    ...
    localparam N_RX_CHANNELS =   N_SPI + N_HYPER + N_MRAM + N_JTAG + N_SDIO + N_UART + N_I2C + N_I2S + N_CAM + 2*N_CSI2 + N_FPGA + N_EXT_PER + N_SPIS + N_SCIF;
    localparam N_TX_CHANNELS = 2*N_SPI + N_HYPER + N_MRAM + N_JTAG + N_SDIO + N_UART + N_I2C + N_I2S + N_FPGA + N_EXT_PER + N_SPIS + N_SCIF;
    ...
    localparam N_PERIPHS = N_SPI + N_HYPER + N_UART + N_MRAM + N_I2C + N_CAM + N_I2S + N_CSI2 + N_SDIO + N_JTAG + N_FILTER + N_FPGA + N_EXT_PER + N_SPIS + N_SCIF;
    ...
    localparam CH_ID_TX_SPIS    = CH_ID_TX_SCIF+1;
...
`endif
    ...
    //SPIS 
    logic [N_SPIS-1:0]   spis_err_event;
    generate
    ...
    assign s_events[4*(PER_ID_SPIS+g_spis)+2]          = 1'b0;
    assign s_events[4*(PER_ID_SPIS+g_spis)+3]          = spis_err_event[g_spis];
    ...
    udma_spis #(
      ...
      .TRANS_SIZE(TRANS_SIZE)
        ...
        .periph_clk_i        ( s_clk_periphs_per[PER_ID_SPIS+g_spis]     ),
        .rstn_i              ( sys_resetn_i                          ),
        ...
        .err_event_o         ( spis_err_event[g_spis]                     ),
