`ifndef RTLROOT
`define RTLROOT /work/daric/design/rtl/
`endif

`ifndef IPSROOT
`define IPSROOT /work/daric/design/ips/
`endif

//`define ../rtl/filename" "`RTLROOT``filename``"
//`define IPSFILE(filename" "`IPSROOT``filename``"
...
`include "ips/arm_sram_macro/rf1kx72/rf1kx72.v"
`include "ips/arm_sram_macro/rf256x27/rf256x27.v"
`include "ips/arm_sram_macro/rf512x39/rf512x39.v"
`include "ips/arm_sram_macro/rf128x31/rf128x31.v"
...
`include "ips/./cortexm7/logical/cortexm7_integration/verilog/CORTEXM7INTEGRATIONCS.v"
