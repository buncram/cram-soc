...
//  .LENW   (8),
//  .UW     (8)
  assign m0.awid = nic1.AWID_m0|'0;
  assign m0.arid = nic1.ARID_m0|'0;
  assign m1.awid = nic1.AWID_m1|'0;
  assign m1.arid = nic1.ARID_m1|'0;
  assign m2.awid = nic1.AWID_m2|'0;
  assign m2.arid = nic1.ARID_m2|'0;
  assign m3.awid = nic1.AWID_m3|'0;
  assign m3.arid = nic1.ARID_m3|'0;
  ...
  assign s2.bid = nic1.BID_s2;
  assign s2.rid = nic1.RID_s2;
