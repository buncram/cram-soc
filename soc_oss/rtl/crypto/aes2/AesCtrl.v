...
output wire      EncEn;
output wire      DecEn;
output wire      FirstRound;
output wire      LastRound;
output wire      AesDone;

input  wire [31:0]DataPathCtrlDat;
output wire [31:0]CtrlDataPathDat;
...
assign Mode1Adr = Mode1State == MODE1_READ0  ? 8'd68:
                  ...
                  Mode1State == MODE1_WRITE0 ? 8'd68:
                  Mode1State == MODE1_WRITE1 ? 8'd69:
                  Mode1State == MODE1_WRITE2 ? 8'd70:
                  Mode1State == MODE1_WRITE3 ? 8'd71:
                                               8'd0 ;
