...
// ■■■■■■■■■■■■■■■
    ...
    logic mfsmcheckscrt, chkpass, chkprepass, chkdone;
...
// ■■■■■■■■■■■■■■■
    ...
    apb_fr #(.A('h0c), .DW(6))      sfr_fr          (.fr({chkpass, chkdone, chnli_done, chnlo_done, hash_done, mfsm_done}), .prdata32(),.*);
...
// ■■■■■■■■■■■■■■■
    ...
    `theregrn( chkprepass ) <=  ~mfsmcheckscrt ? '0 :
                                chnli_start ? '1 :
                                chnli_wpreq.segwr ? chkprepass && ( chnli_wpreq.segwdat == '0 ) : chkprepass;

    `theregrn( chkdone ) <= mfsmcheckscrt & chnli_done ;
