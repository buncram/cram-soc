...
//    `theregrn( mfsmtog ) <= ( mfsm != mfsmnext ) & ( mfsmnext != MFSM_IDLE );
    ...
    assign opt_n0hwr = (( mfsm == MFSM_LD_N ) | ( mfsm == MFSM_LD_P )) & ( chnli_wpreq.segptr == 1 ) & chnli_wpreq.segwr ;
...
// ■■■■■■■■■■■■■■■
    ...
    logic [7:0] pkeir;
    assign pkeir =  ( mfsm == MFSM_J0 ) ? 8'h20 : cr_func;
...
// ■■■■■■■■■■■■■■■
    ...
    logic mfsm_ld_con1_en, mfsm_ld_qi_z;
    assign mfsm_ld_con1_en = mfsm == MFSM_LD_CON1;
    assign mfsm_ld_qi_z = ( mfsm == MFSM_LD_Q0I | mfsm == MFSM_LD_Q1I ) & ( ecpsegidx > 1 );
    assign chnl_ramwdat = chnlo_en ?  chnlo_rpreq.segwdat  : 
                          chnlx_en ?( chnlx_rpreq.segrd ? 
                                      chnlx_rpreq.segwdat  :
                                      chnlx_wpreq.segwdat ):
                                      ( mfsm_ld_con1_en | mfsm_ld_qi_z 
                                            ? ( chnli_wpreq.segptr == 0 ) : chnli_wpreq.segwdat )  ; //chnli_en ?
    ...
    assign ramwr0 = pcore_en ? {8{pcore_ramwr0}} : {{4{chnl_ramwr0h}},{4{chnl_ramwr0l}}};
    assign ramwr1 = pcore_en ? {8{pcore_ramwr1}} : {{4{chnl_ramwr1h}},{4{chnl_ramwr1l}}};
...
// ■■■■■■■■■■■■■■■
    ...
    cryptoram #(
        ...
        .clk(clkram), .resetn, .cmsatpg, .cmsbist,
        .clkram, .clkramen('1),
        .ramclr(ramclr),
