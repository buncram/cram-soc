...
This is the core secure-domain SoC for Betrusted. You can view the latest register set at
https://ci.betrusted.io/job/betrusted-soc-doc/lastSuccessfulBuild/artifact/build/documentation/_build/html/index.html
