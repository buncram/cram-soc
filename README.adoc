...
1. Download the Risc-V toolchain from https://www.sifive.com/products/tools/ and put it in your PATH. The bootloader is pure Rust, so the toolchain isn't needed to build the bootloader, but LiteX requires its presence to work.
