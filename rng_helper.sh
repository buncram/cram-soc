...
while [ $i -le $ITERATIONS ]
	 do
	     SUFFIX=$(date +'%s')
	     NAME=$1_$SUFFIX
	     echo "Dumping 8MiB memory to $NAME"
	     ...
	     # takes 36 seconds to run the generator on boot
	     # sleep 40
	     sleep 4
	     yes | riscv64-unknown-elf-gdb -ex 'file /home/bunnie/code/betrusted-soc/fw/target/riscv32imac-unknown-none-elf/release/betrusted-soc' -ex 'target remote 10.0.245.90:3333' -ex "dump memory $NAME 0x40080000 0x40090000" -ex 'quit'
	     ((i++))
done
